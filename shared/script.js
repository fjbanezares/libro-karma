...
const KARMA_CHAPTERS = [
    ...
    { icon: '88', folder: '88_la_semilla_del_dharma',
      es:'La Semilla del Dharma y el Renacimiento del Buscador', en:'The Seed of Dharma and the Seeker\'s Rebirth', it:'Il Seme del Dharma e la Rinascita del Cercatore', zh:'法之种子与求道者的重生',
      ar:'بذرة الدارما وولادة الباحث الجديدة', ru:'Семя Дхармы и Перерождение Искателя', de:'Der Same des Dharma und die Wiedergeburt des Suchenden', fr:'La Graine du Dharma et la Renaissance du Chercheur',
      ja:'法の種と求道者の転生', pt:'A Semente do Dharma e o Renascimento do Buscador', vi:'Hạt Giống Pháp Và Sự Tái Sinh Của Người Tìm Đạo' },
    { icon: '89', folder: '89_el_merito_fracturado',
      es:'El Mérito Fracturado', en:'The Fractured Merit', it:'Il Merito Fratturato', zh:'破碎的功德',
      ar:'الاستحقاق المكسور', ru:'Расколотая Заслуга', de:'Das Gebrochene Verdienst', fr:'Le Mérite Fracturé',
      ja:'ひび割れた功徳', pt:'O Mérito Fraturado', vi:'Phước Lành Không Trọn Vẹn' },
    { icon: '90', folder: '90_la_promesa_rota',
      es:'La Promesa Rota y los Cimientos de Arena', en:'The Broken Promise and the Foundations of Sand', it:'La Promessa Infranta e le Fondamenta di Sabbia', zh:'破碎的承诺与沙上之基',
      ar:'الوعد المكسور وأساسات الرمل', ru:'Нарушенное Обещание и Фундамент из Песка', de:'Das Gebrochene Versprechen und das Fundament aus Sand', fr:'La Promesse Brisée et les Fondations de Sable',
      ja:'破られた約束と砂の上の礎', pt:'A Promessa Quebrada e os Alicerces de Areia', vi:'Lời Hứa Bị Phá Vỡ Và Nền Móng Cát' },
    { icon: '91', folder: '91_la_difamacion_sagrada',
      es:'La Difamación Sagrada', en:'The Sacred Defamation', it:'La Diffamazione Sacra', zh:'神圣的诽谤',
      ar:'التجديف المقدس', ru:'Священная Клевета', de:'Die Heilige Verleumdung', fr:'La Diffamation Sacrée',
      ja:'神聖な誹謗', pt:'A Difamação Sagrada', vi:'Sự Phỉ Báng Thiêng Liêng' },
    { icon: '92', folder: '92_la_autopista_del_dharma',
      es:'La Autopista del Dharma', en:'The Dharma Highway', it:'L\'autostrada del Dharma', zh:'佛法公路',
      ar:'طريق darma السريع', ru:'Шоссе Дхармы', de:'Der Dharma Highway', fr:'L\'autoroute du Dharma',
      ja:'ダルマ・ハイウェイ', pt:'A Rodovia do Dharma', vi:'Đại lộ Phật pháp' },
    { icon: '93', folder: '93_la_persecucion_del_sabio',
      es:'La Persecución del Sabio', en:'The Persecution of the Sage', it:'La persecuzione del saggio', zh:'迫害智者',
      ar:'اضطهاد الحكيم', ru:'Преследование мудреца', de:'Die Verfolgung des Weisen', fr:'La persécution du sage',
      ja:'賢者の迫害', pt:'A Perseguição do Sábio', vi:'Bức hại bậc chân tu' },
    { icon: '94', folder: '94_la_ostentacion_del_merito',
      es:'La Ostentación del Mérito', en:'The Ostentation of Merit', it:'L\'Ostentazione del Merito', zh:'炫耀功德',
      ar:'التباهي بالاستحقاق', ru:'Тщеславие заслуги', de:'Die Prachtsucht des Verdienstes', fr:'L\'Ostentation du Mérite',
      ja:'功徳の誇示', pt:'A Ostentação do Mérito', vi:'Khoe khoang công đức' },
    { icon: '95', folder: '95_la_envidia_de_la_excelencia',
      es:'La Envidia de la Excelencia', en:'The Envy of Excellence', it:'L\'Invidia dell\'Eccellenza', zh:'嫉妒优胜者',
      ar:'حسد التميز', ru:'Зависть к превосходству', de:'Der Neid auf die Exzellenz', fr:'L\'Envie de l\'Excellence',
      ja:'優秀さへの嫉妬', pt:'A Inveja da Excelência', vi:'Đố kỵ người giỏi hơn mình' },
    { icon: '96', folder: '96_la_alabanza_a_los_virtuosos',
      es:'La Alabanza a los Virtuosos', en:'Praising Good-Hearted People', it:'L\'Elogio dei Virtuosi', zh:'赞叹善人',
      ar:'الثناء على المحسنين', ru:'Восхваление добродетельных', de:'Das Lob der Tugendhaften', fr:'L\'Éloge des Hommes de Bien',
      ja:'善人への称賛', pt:'O Elogio aos Virtuosos', vi:'Ngợi ca người tốt' },
    { icon: '97', folder: '97_la_profanacion_del_habito_sagrado',
      es:'La Profanación del Hábito Sagrado', en:'The Profanation of the Sacred Robe', it:'La Profanazione dell\'Abito Sacro', zh:'假亵圣衣',
      ar:'تنجيس الرداء المقدس', ru:'Осквернение священного одеяния', de:'Die Entweihung des heiligen Gewandes', fr:'La Profanation de l\'Habit Sacré',
      ja:'聖衣の冒涜', pt:'A Profanação do Hábito Sagrado', vi:'Giả vờ xuất gia vào Tăng đoàn để phá đạo' },
];
