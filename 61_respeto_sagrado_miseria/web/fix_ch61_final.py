    ...
    <main class="main-content">
        ...
        <div class="story-container">
            ...
            <div class="story-block fade-in">
                ...
                <p class="zh">这种业力的“前因”是充斥着奢华却精神空虚的生活，神圣虽被展示却未被践行。而“后果”则是荒漠：由于失去了敬畏的指南针，悲剧似乎永无止境。为了治愈这种业力，我们必须学会用心灵之眼观察，承认每个象征都是一扇门，唯有在谦卑面前才会开启。唯有懂得在比自己更伟大的事物面前俯伏的人，才能重新获得顶天立地于世间的尊严。</p>
            ...
            <div class="story-block parable-block fade-in" style="margin-top: 3rem; margin-bottom: 2rem; padding: 0 1rem;">
                ...
                <p class="ja" style="font-style: italic; color: #ddd; line-height: 1.8; text-align: justify; margin-bottom: 1.5rem;">ある日、サイラスは、忘れ去られた聖人の祭壇から来たとされる小さな油灯を手に入れました。そのランプは、決して消えることのない柔らかな黄金の光を放っていました。しかし、サイラスは、ある遊女を感銘させようとして、ランプの聖なる油を使ってワインに香りをつけようと決めたのです。油がグラスに触れた瞬間、ランプは千々に砕け、光は消え去り、部屋は絶対的な凍てつく闇に包みました。</p>
