    ...
    <main class="main-content">
        ...
        <section class="hero-section">
            ...
            <div class="hero-content">
                ...
                <h1 class="chapter-title">
                    <span class="es">Vivir con Honestidad y Sabiduría</span>
                    <span class="en">Living with Honesty and Wisdom</span>
                    <span class="it">Vivere con Onestà e Saggezza</span>
                    <span class="zh">诚实与智慧的生活</span>
                    <span class="ar">العيش بصدق وحكمة</span>
                    <span class="ru">Жить в честности и мудрости</span>
                    <span class="de">Mit Ehrlichkeit und Weisheit leben</span>
                    <span class="fr">Vivre avec Honnêteté et Sagesse</span>
                    <span class="ja">正直さと知恵とともに生きる</span>
                    <span class="pt">Viver com Honestidade e Sabedoria</span>
                    <span class="vi">Sống Chân Thật Và Trí Tuệ</span>
                </h1>
                <p class="subtitle">
                    ...
                    <span class="pt">"A verdade não se busca, permite-se; apenas o coração honesto é capaz de ver o que sempre esteve lá."</span>
        ...
        <div class="story-container">
            ...
            <div class="story-block parable-block fade-in" style="margin-top: 3rem; margin-bottom: 2rem; padding: 0 1rem;">
                ...
                <p class="it" style="font-style: italic; color: #ddd; line-height: 1.8; text-align: justify; margin-bottom: 1.5rem;">Un giorno, disperato, viaggiò nella Valle Silenziosa per vedere un vecchio eremita che, si diceva, potesse vedere attraverso le montagne. Al suo arrivo, Elian supplicò: "Saggio, restituiscimi la vista. Il mondo è diventato grigio e confuso". L'anziano, senza aprire gli occhi, gli porse una piccola ciotola d'acqua limpida e disse: "Il mondo non è grigio, Elian. I tuoi occhi sono coperti dal fumo delle tue stesse parole. Ogni volta che hai ingannato un altro, hai posto un velo sul tuo spirito. Per vedere la verità fuori, devi prima smettere di nasconderla dentro".</p>
                <p class="it" style="font-style: italic; color: #ddd; line-height: 1.8; text-align: justify; margin-bottom: 1.5rem;">Elian passò mesi nella valle, praticando il silenzio e, soprattutto, la verità. Confessò i suoi inganni, restituì ciò che aveva ottenuto con falsità e imparò a parlare con il cuore nudo. Fu un processo doloroso, come se gli venissero strappate croste dagli occhi. Un giorno, all'alba, vide una goccia di rugiada su una foglia di loto. Era così perfetta e limpida che scoppiò a piangere. In quel momento, non solo recuperò la vista, ma iniziò a vedere l'essenza di tutte le cose: l'amore negli estranei, la saggezza nel vento e la divinità nel silenzio.</p>
                <p class="it" style="font-style: italic; color: #ddd; line-height: 1.8; text-align: justify; margin-bottom: 1.5rem;">Tornò nella sua città, ma non era più un mercante di bugie, bensì un faro di verità. Chi lo guardava sentiva che le proprie ombre si dissolvevano. Elian comprese che l'onestà non era un peso morale, ma il prezzo della libertà assoluta. Il suo Ikigai, il suo scopo, divenne chiaro come il cristallo: aiutare gli altri a pulire i propri specchi affinché potessero vedere la bellezza infinita che la menzogna aveva loro sempre nascosto.</p>

                <!-- ZH -->
                <p class="zh" style="font-style: italic; color: #ddd; line-height: 1.8; text-align: justify; margin-bottom: 1.5rem;">从前有一个叫埃连（Elian）的人，住在一个充满扭曲镜子的城市里。埃连以狡黠闻名；他知道如何说出每个人想听的话，即使那是假的。凭借谎言，他积累了巨大的财富和声望。然而，随着岁月的流逝，奇怪的事情发生了：埃连看世界变得模糊。朋友们的脸看起来像影子，太阳本身也像天空中的一块模糊光斑。他咨询了医生和智者，但没有人能治好他的渐进性失明。</p>
                <p class="zh" style="font-style: italic; color: #ddd; line-height: 1.8; text-align: justify; margin-bottom: 1.5rem;">绝望中，他前往寂静谷拜访一位据说能看穿大山的隐士。抵达后，埃连哀求道：“智者，请恢复我的视力。世界变得灰暗混乱。”老人闭着眼睛，递给他一小碗清澈的水说：“世界并不灰暗，埃连。你的眼睛被你自己谎言产生的烟雾覆盖了。每当你欺骗别人，你就给自己的灵魂蒙上了一层纱。要看清外面的真相，你必须先停止在内心隐藏真相。”</p>
                <p class="zh" style="font-style: italic; color: #ddd; line-height: 1.8; text-align: justify; margin-bottom: 1.5rem;">埃连在山谷里待了几个月，练习沉默，尤其是练习真实。他坦白了自己的欺骗，归还了通过虚假手段获得的财物，学会了赤诚相待。这是一个痛苦的过程，就像是从眼睛里剥掉血痂。一天清晨，他看到莲叶上的一滴露珠。它是如此完美清澈，他不禁流下泪来。那一刻，他不仅恢复了视力，还开始看到了万物的本质：陌生人中的爱，风中的智慧，以及沉默中的神性。</p>
                <p class="zh" style="font-style: italic; color: #ddd; line-height: 1.8; text-align: justify; margin-bottom: 1.5rem;">他回到了城市，不再是一个谎言贩子，而是一座真理的灯塔。看着他的人都感觉到自己的阴影在消散。埃连明白，诚实不是道德负担，而是绝对自由的代价。他的生命意义（Ikigai）变得晶莹剔透：帮助他人清理自己的镜子，让他们能看到谎言一直遮蔽的无限美景。</p>

                <!-- AR -->
                <p class="ar" style="font-style: italic; color: #ddd; line-height: 1.8; text-align: justify; margin-bottom: 1.5rem;">كان يا مكان، كان هناك رجل يدعى إليان يعيش في مدينة من المرايا المشوهة. اشتهر إليان بدهائه؛ فقد كان يعرف كيف يقول ما يريد كل شخص سماعه، حتى لو كان زيفاً. بفضل أكاذيبه، جمع ثروة طائلة وجاهاً عريضاً. ومع ذلك، مع مرور السنين، بدأ شيء غريب يحدث: بدأ إليان يرى العالم ضبابياً. بدت وجوه أصدقائه كظلال، والشمس نفسها بدت كبقعة معتمة في السماء. استشار الأطباء والحكماء، لكن لم يجد أحد علاجاً لعمى بصره التدريجي.</p>
                <p class="ar" style="font-style: italic; color: #ddd; line-height: 1.8; text-align: justify; margin-bottom: 1.5rem;">في يأس، سافر إلى الوادي الصامت لرؤية ناسك عجوز قيل إنه يستطيع الرؤية عبر الجبال. عند وصوله، توسل إليان: "أيها الحكيم، أعد لي بصري. لقد أصبح العالم رمادياً ومربكاً". قدم له العجوز، دون أن يفتح عينيه، وعاءً صغيراً من الماء الصافي وقال: "العالم ليس رمادياً يا إليان. عيناك مغطاة بدخان كلماتك الخاصة. في كل مرة خدعت فيها أحداً، وضعت حجاباً على روحك. لرؤية الحقيقة في الخارج، يجب عليك أولاً التوقف عن إخفائها في الداخل".</p>
                <p class="ar" style="font-style: italic; color: #ddd; line-height: 1.8; text-align: justify; margin-bottom: 1.5rem;">قضى إليان شهوراً في الوادي، ممارساً الصمت، والأهم من ذلك، الصدق. اعترف بخداعه، وأعاد ما حصل عليه بالزيف، وتعلم التحدث بقلب عارٍ. كانت عملية مؤلمة، وكأن قشوراً تُنزع من عينيه. في أحد الأيام عند الفجر، رأى قطرة ندى على ورقة لوتس. كانت مثالية وصافية لدرجة أنه أجهش بالبكاء. في تلك اللحظة، لم يستعد بصره فحسب، بل بدأ يرى جوهر كل الأشياء: الحب في الغرباء، والحكمة في الريح، والألوهية في الصمت.</p>
                <p class="ar" style="font-style: italic; color: #ddd; line-height: 1.8; text-align: justify; margin-bottom: 1.5rem;">عاد إلى مدينته، لكنه لم يعد تاجراً للأكاذيب، بل منارة للحقيقة. شعر من ينظر إليه أن ظلالهم تذوب. فهم إليان أن الصدق لم يكن عبئاً أخلاقياً، بل ثمن الحرية المطلقة. أصبح غرضه (إيكيغاي) واضحاً كالكريستال: مساعدة الآخرين على تنظيف مراياهم الخاصة ليروا الجمال اللامتناهي الذي أخفاه الكذب عنهم دائماً.</p>
                ...
                <p class="fr" style="font-style: italic; color: #ddd; line-height: 1.8; text-align: justify; margin-bottom: 1.5rem;">Désespéré, il se rendit dans la Vallée Silencieuse pour voir un vieil ermite dont on disait qu'il pouvait voir à travers les montagnes. À son arrivée, Elian supplia : « Sage, rends-moi la vue. Le monde est devenu gris et confus. » Le vieillard, sans ouvrir les yeux, lui tendit un bol d'eau claire et dit : « Le monde n'est pas gris, Elian. Tes yeux sont couverts par la fumée de tes propres paroles. Chaque fois que tu as trompé autrui, tu as posé un voile sur ton esprit. Pour voir la vérité à l'extérieur, tu dois d'abord cesser de la cacher à l'intérieur. »</p>
                <p class="fr" style="font-style: italic; color: #ddd; line-height: 1.8; text-align: justify; margin-bottom: 1.5rem;">Elian passa des mois dans la vallée, pratiquant le silence et surtout la vérité. Il confessa ses tromperies, rendit ce qu'il avait obtenu par des mensonges et apprit à parler avec un cœur nu. Ce fut un processus douloureux, comme si on lui arrachait des croûtes des yeux. Un jour, à l'aube, il vit une goutte de rosée sur une feuille de lotus. Elle était si parfaite et pure qu'il éclata en sanglots. À cet instant, il retrouva non seulement la vue, mais commença à voir l'essence de toutes choses : l'amour chez les inconnus, la sagesse dans le vent et la divinité dans le silence.</p>
                <p class="fr" style="font-style: italic; color: #ddd; line-height: 1.8; text-align: justify; margin-bottom: 1.5rem;">Il retourna dans sa ville, non plus comme un marchand de mensonges, mais comme un phare de vérité. Ceux qui le regardaient sentaient leurs propres ombres se dissoudre. Elian comprit que l'honnêteté n'était pas un fardeau moral, mais le prix de la liberté absolue. Son Ikigai, son but, devint clair comme le cristal : aider les autres à nettoyer leurs propres miroirs pour voir la beauté infinie que le mensonge leur avait toujours cachée.</p>
                ...
                <!-- VI -->
                <p class="vi" style="font-style: italic; color: #ddd; line-height: 1.8; text-align: justify; margin-bottom: 1.5rem;">Ngày xửa ngày xưa, có một người đàn ông tên là Elian sống trong một thành phố của những chiếc gương biến dạng. Elian nổi tiếng với sự xảo quyệt; anh ta biết nói những gì mỗi người muốn nghe, ngay cả khi điều đó là giả dối. Nhờ những lời nói dối, anh ta đã tích lũy được khối tài sản kếch xù và danh tiếng lẫy lừng. Tuy nhiên, năm tháng trôi qua, một điều kỳ lạ bắt đầu xảy ra: Elian bắt đầu nhìn thế giới mờ ảo. Khuôn mặt của bạn bè anh trông như những bóng ma, và mặt trời trông như một vệt mờ đục trên bầu trời. Anh đã tham khảo ý kiến của các bác sĩ và nhà thông thái, nhưng không ai tìm ra cách chữa trị cho chứng mù lòa tiến triển của mình.</p>
